...
------------------------------------------------------------------------
** TODO - make sure that spectrum update only gets one after loop
** TODO - make sure that spectrum is aligned correctly in window
** TODO - figure out why my spectrum is so noisy, missing windowing?
** TODO - make sure that spectrum after loop doesn't get busy error
** TODO - figure out why rf-gain comes up essentially muted
