...
snit::type ::hamlib-proxy::proxy {
	...
	$self value-set level {
	    ...
	    METER VOXGAIN ANTIVOX SLOPE_LOW SLOPE_HIGH RAWSTR SQLSTAT SWR
	    ALC STRENGTH
	}
	$self value-set parm {ANN APO BACKLIGHT BEEP TIME BAT KEYLIGHT}
    ...
    method server {port} {
	socket -server [mymethod accept] $port
    }
	...
	lappend caps {Get functions: FAGC NB COMP VOX TONE TSQL SBKIN FBKIN ANF NR AIP APF MON MN RF ARO LOCK MUTE VSC REV SQL ABM BC MBC AFC SATMODE SCOPE RESUME TBURST }
	lappend caps {Set functions: FAGC NB COMP VOX TONE TSQL SBKIN FBKIN ANF NR AIP APF MON MN RF ARO LOCK MUTE VSC REV SQL ABM BC MBC AFC SATMODE SCOPE RESUME TBURST }
	lappend caps {Get level: PREAMP(0..0/0) ATT(0..0/0) VOX(0..0/0) AF(0..0/0) RF(0..0/0) SQL(0..0/0) IF(0..0/0) APF(0..0/0) NR(0..0/0) PBT_IN(0..0/0) PBT_OUT(0..0/0) CWPITCH(0..0/10) RFPOWER(0..0/0) MICGAIN(0..0/0) KEYSPD(0..0/0) NOTCHF(0..0/0) COMP(0..0/0) AGC(0..0/0) BKINDL(0..0/0) BAL(0..0/0) METER(0..0/0) VOXGAIN(0..0/0) ANTIVOX(0..0/0) SLOPE_LOW(0..0/0) SLOPE_HIGH(0..0/0) BKIN_DLYMS(0..0/0) RAWSTR(0..0/0) SWR(0..0/0) ALC(0..0/0) STRENGTH(0..0/0) }
	lappend caps {Set level: PREAMP(0..0/0) ATT(0..0/0) VOX(0..0/0) AF(0..0/0) RF(0..0/0) SQL(0..0/0) IF(0..0/0) APF(0..0/0) NR(0..0/0) PBT_IN(0..0/0) PBT_OUT(0..0/0) CWPITCH(0..0/10) RFPOWER(0..0/0) MICGAIN(0..0/0) KEYSPD(0..0/0) NOTCHF(0..0/0) COMP(0..0/0) AGC(0..0/0) BKINDL(0..0/0) BAL(0..0/0) METER(0..0/0) VOXGAIN(0..0/0) ANTIVOX(0..0/0) SLOPE_LOW(0..0/0) SLOPE_HIGH(0..0/0) BKIN_DLYMS(0..0/0) }
	lappend caps {Extra levels: MGL MGF MGO}
	lappend caps {Get parameters: ANN(0..0/0) APO(0..0/0) BACKLIGHT(0..0/0) BEEP(0..0/0) TIME(0..0/0) BAT(0..0/0) KEYLIGHT(0..0/0) }
	lappend caps {Set parameters: ANN(0..0/0) APO(0..0/0) BACKLIGHT(0..0/0) BEEP(0..0/0) TIME(0..0/0) KEYLIGHT(0..0/0) }
	lappend caps {Extra parameters: MGP}
	lappend caps {Mode list: AM CW USB LSB RTTY FM WFM CWR RTTYR }
	...
	lappend caps "Has priv data:	[$self is-enabled something]"
	lappend caps "Has Init:	[$self is-enabled something]"
	lappend caps "Has Cleanup:	[$self is-enabled something]"
	lappend caps "Has Open:	[$self is-enabled something]"
	lappend caps "Has Close:	[$self is-enabled something]"
	lappend caps "Can set Conf:	[$self is-enabled something]"
	lappend caps "Can get Conf:	[$self is-enabled something]"
	lappend caps "Can set Frequency:	[$self is-enabled something]"
	lappend caps "Can get Frequency:	[$self is-enabled something]"
	lappend caps "Can set Mode:	[$self is-enabled something]"
	lappend caps "Can get Mode:	[$self is-enabled something]"
	lappend caps "Can set VFO:	[$self is-enabled something]"
	lappend caps "Can get VFO:	[$self is-enabled something]"
	lappend caps "Can set PTT:	[$self is-enabled something]"
	lappend caps "Can get PTT:	[$self is-enabled something]"
	lappend caps "Can get DCD:	[$self is-enabled something]"
	lappend caps "Can set Repeater Duplex:	[$self is-enabled something]"
	lappend caps "Can get Repeater Duplex:	[$self is-enabled something]"
	lappend caps "Can set Repeater Offset:	[$self is-enabled something]"
	lappend caps "Can get Repeater Offset:	[$self is-enabled something]"
	lappend caps "Can set Split Freq:	[$self is-enabled something]"
	lappend caps "Can get Split Freq:	[$self is-enabled something]"
	lappend caps "Can set Split Mode:	[$self is-enabled something]"
	lappend caps "Can get Split Mode:	[$self is-enabled something]"
	lappend caps "Can set Split VFO:	[$self is-enabled something]"
	lappend caps "Can get Split VFO:	[$self is-enabled something]"
	lappend caps "Can set Tuning Step:	[$self is-enabled something]"
	lappend caps "Can get Tuning Step:	[$self is-enabled something]"
	lappend caps "Can set RIT:	[$self is-enabled something]"
	lappend caps "Can get RIT:	[$self is-enabled something]"
	lappend caps "Can set XIT:	[$self is-enabled something]"
	lappend caps "Can get XIT:	[$self is-enabled something]"
	lappend caps "Can set CTCSS:	[$self is-enabled something]"
	lappend caps "Can get CTCSS:	[$self is-enabled something]"
	lappend caps "Can set DCS:	[$self is-enabled something]"
	lappend caps "Can get DCS:	[$self is-enabled something]"
	lappend caps "Can set CTCSS Squelch:	[$self is-enabled something]"
	lappend caps "Can get CTCSS Squelch:	[$self is-enabled something]"
	lappend caps "Can set DCS Squelch:	[$self is-enabled something]"
	lappend caps "Can get DCS Squelch:	[$self is-enabled something]"
	lappend caps "Can set Power Stat:	[$self is-enabled something]"
	lappend caps "Can get Power Stat:	[$self is-enabled something]"
	lappend caps "Can Reset:	[$self is-enabled something]"
	lappend caps "Can get Ant:	[$self is-enabled something]"
	lappend caps "Can set Ant:	[$self is-enabled something]"
	lappend caps "Can set Transceive:	[$self is-enabled something]"
	lappend caps "Can get Transceive:	[$self is-enabled something]"
