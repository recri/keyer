# -*- tcl -*-
# # ## ### ##### ######## #############
# (C) 2019 Roger E Critchlow Jr

# Channel using a jack ring buffer for storage

# @@ Meta Begin
# Package sdrtcl::ringchan 1.0
# Meta as::author {Roger E Critchlow Jr}
# Meta as::copyright 2019
# Meta as::license BSD
# Meta description In memory channel using a jack_ring_buffer
# Meta description for storage. Based on Tcl 8.5's channel
...
proc ::sdrtcl::ringchan {} {
    return [::chan create {read write} [ringchan::implementation new]]
}

oo::class create ::sdrtcl::ringchan::implementation {
