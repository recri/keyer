...
package provide sdrkit::label-spinbox 1.0.0
...
snit::widget sdrkit::label-spinbox {
    component label
    component spinbox
	...
	install spinbox using ttk::spinbox $win.s -textvar [myvar data(value)] -command [mymethod Value]
	$self configure {*}$args
