...
package provide sdrkit::label-scale 1.0.0
...
snit::widget sdrkit::label-scale {
    component label
    component scale
	...
	install scale using ttk::scale $win.s -variable [myvar data(value)] -command [mymethod Value]
	$self configure {*}$args
